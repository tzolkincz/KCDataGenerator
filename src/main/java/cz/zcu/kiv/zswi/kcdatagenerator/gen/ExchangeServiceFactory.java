...
public class ExchangeServiceFactory {
	...
	public static ExchangeService create(String exchangeUrl, String userAddress, String passwd)
	...
	public static ExchangeService create(String exchangeUrl, GeneratedUser u, String domain)
			throws URISyntaxException {
